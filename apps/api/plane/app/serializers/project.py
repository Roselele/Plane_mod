...
class ProjectListSerializer(DynamicBaseSerializer):
    ...
    work_categories = serializers.SerializerMethodField()
    ...
    def get_work_categories(self, obj):
        """Aggregate unique work_category values from phase-level issues"""
        values = (
            Issue.objects.filter(
                project_id=obj.id,
                parent__isnull=False,
                parent__has_phases=True,
                work_category__isnull=False,
            )
    ...
    def get_okrs(self, obj):
        """Aggregate unique okr values from phase-level issues"""
        values = (
            Issue.objects.filter(
                project_id=obj.id,
                parent__isnull=False,
