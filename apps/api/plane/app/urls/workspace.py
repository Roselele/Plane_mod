...
urlpatterns = [
    ...
    # Industries (workspace-level, user customizable)
    path(
        "workspaces/<str:slug>/industries/",
        IndustryViewSet.as_view({"get": "list", "post": "create"}),
        name="workspace-industries",
    ),
    path(
        "workspaces/<str:slug>/industries/<uuid:pk>/",
        IndustryViewSet.as_view({"get": "retrieve", "patch": "partial_update", "delete": "destroy"}),
        name="workspace-industries",
    ),
]
