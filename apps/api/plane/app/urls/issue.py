...
urlpatterns = [
    ...
    # Issue Hidden
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/issues/<uuid:issue_id>/hide/",
        IssueHiddenViewSet.as_view({"post": "hide", "delete": "unhide", "get": "hidden_status"}),
        name="project-issue-hidden",
    ),
    ## End Issue Hidden
    # Issue Reactions
    path(
