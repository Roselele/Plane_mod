...
def get_default_preferences():
    return {"pages": {"block_display": True}, "navigation": {"default_tab": "info", "hide_in_more_menu": []}}
...
class Project(BaseModel):
    ...
    category = models.CharField(max_length=50, choices=CATEGORY_CHOICES, null=True, blank=True, verbose_name="类别")
    ...
    # === Part 1: 需求/商务信息 ===
    demand_proposer = models.CharField(max_length=255, null=True, blank=True, verbose_name="需求提出人")
    source_department = models.CharField(max_length=255, null=True, blank=True, verbose_name="来源部门")
    demand_date = models.DateField(null=True, blank=True, verbose_name="需求提出时间")
    client_name = models.CharField(max_length=255, null=True, blank=True, verbose_name="客户名称")
