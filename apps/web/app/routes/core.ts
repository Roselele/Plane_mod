  ...
  layout("./(all)/layout.tsx", [
    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        // Member Status (成员状态时间表)
        layout("./(all)/[workspaceSlug]/(projects)/member-status/layout.tsx", [
          route(
            ":workspaceSlug/member-status",
            "./(all)/[workspaceSlug]/(projects)/member-status/page.tsx"
          ),
        ]),
        ...
        layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/layout.tsx", [
          ...
          // Info page
          layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/info/layout.tsx", [
            route(
              ":workspaceSlug/projects/:projectId/info",
              "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/info/page.tsx"
            ),
          ]),
        ]),
      ...
      layout("./(all)/[workspaceSlug]/(settings)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/projects/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/layout.tsx", [
            ...
            // Project Industries
            route(
              ":workspaceSlug/settings/projects/:projectId/industries",
              "./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/industries/page.tsx"
            ),
          ]),
        ]),
      ]),
