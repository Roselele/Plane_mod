...
import { CycleIcon, IntakeIcon, ModuleIcon, PageIcon, ViewsIcon, WorkItemsIcon, InfoIcon } from "@plane/propel/icons";
    ...
    (workspaceSlug: string, projectId: string): TNavigationItem[] => [
      {
        ...
        key: "info",
        name: "信息",
        href: `/${workspaceSlug}/projects/${projectId}/info`,
        icon: InfoIcon,
      ...
      // Cycles and Modules temporarily disabled
      // {
