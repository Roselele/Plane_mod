...
import { XCircle, ArchiveRestoreIcon, EyeOffIcon } from "lucide-react";
// plane imports
...
export const useMenuItemFactory = (props: MenuItemFactoryProps) => {
  ...
  const createHideMenuItem = (): TContextMenuItem => ({
    key: "hide",
    title: "隐藏",
    icon: EyeOffIcon,
    action: () => handleOptionalAction(props.handleHide, "Hide"),
    shouldRender: isEditingAllowed && !props.issue.is_hidden,
  });

  const createUnhideMenuItem = (): TContextMenuItem => ({
    key: "unhide",
    title: "取消隐藏",
    icon: EyeOffIcon,
    action: () => handleOptionalAction(props.handleUnhide, "Unhide"),
    shouldRender: isEditingAllowed && props.issue.is_hidden === true,
  });
...
export const useProjectIssueMenuItems = (props: MenuItemFactoryProps): TContextMenuItem[] => {
  ...
  return useMemo(
    () => [
      ...
      factory.createHideMenuItem(),
      factory.createUnhideMenuItem(),
